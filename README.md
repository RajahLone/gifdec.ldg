...
- get /gifdec.ldg/ from [codecs_r4_src.zip](https://ptonthat.fr/files/gifdec/codecs_r4_src.zip) and unpack the contents to ./

- gifdec.ldg.xcodeproj is for Xcode 26.1, you may not need it if you use something else.
